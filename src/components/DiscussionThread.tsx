                                                                    ...
                                                                    {isFirst && (
                                                                        <>
                                                                            ...
                                                                            <div className="bolt-dropdown-expandable bolt-expandable-button inline-flex-row">
                                                                                <button aria-label="Thread status (Active)" aria-expanded="false" aria-haspopup="true" className="bolt-button enabled subtle bolt-focus-treatment" role="button" tabIndex={0} type="button">
