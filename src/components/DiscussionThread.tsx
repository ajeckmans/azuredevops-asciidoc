...
// ⚡ Bolt: Wrapped DiscussionThread in React.memo and replaced submittingReplyId with isSubmitting boolean
// to prevent O(N) re-rendering bottlenecks across the entire list.
