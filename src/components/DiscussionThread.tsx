...
// ⚡ Bolt: Memoize DiscussionThread component and replace global submittingReplyId prop
// with a targeted boolean isSubmitting prop. This prevents O(N) main-thread blocking re-renders
// across the entire thread list when replying to a single thread.
