...
// ⚡ Bolt: Memoize DiscussionThread component to prevent expensive re-rendering loops for large thread lists
// by deriving targeted boolean props (isSubmitting) instead of passing global state IDs.
