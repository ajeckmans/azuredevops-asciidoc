...
// ⚡ Bolt: Memoized DiscussionThread and passed targeted isSubmitting prop
// to prevent O(N) re-renders across all threads when a single thread's reply is submitting
