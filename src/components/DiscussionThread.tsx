...
// ⚡ Bolt: Memoize DiscussionThread and pass targeted boolean (isSubmitting) instead of global submittingReplyId
// to prevent O(N) re-rendering bottlenecks across the entire list when a single reply is submitted.
