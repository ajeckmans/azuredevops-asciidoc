...
// ⚡ Bolt: Added React.memo and replaced submittingReplyId with isSubmitting boolean
// Passing a targeted boolean instead of global ID prevents O(N) re-renders across the whole list
