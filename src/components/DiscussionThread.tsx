...
// ⚡ Bolt: Prevent O(N) re-rendering bottlenecks by memoizing the component and passing
// a targeted boolean prop (isSubmitting) rather than a global submittingReplyId.
