...
// ⚡ Bolt: Memoized DiscussionThread and passed targeted boolean prop (isSubmittingReply)
// instead of global id (submittingReplyId) to prevent O(N) list re-renders.
