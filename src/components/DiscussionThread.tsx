...
// ⚡ Bolt: Memoized DiscussionThread and used targeted boolean prop (isSubmitting)
// instead of global ID to prevent O(N) re-renders across all threads when submitting a reply.
