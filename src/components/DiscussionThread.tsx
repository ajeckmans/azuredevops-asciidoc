...
// ⚡ Bolt: Memoized component and replaced global ID with targeted boolean prop
// to prevent O(N) re-renders across the entire thread list when typing/submitting.
