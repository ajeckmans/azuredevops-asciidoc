...
// ⚡ Bolt: Memoized DiscussionThread and replaced global submitting ID with targeted boolean prop
// to prevent O(N) re-rendering bottlenecks across the entire list of threads when a single thread is submitted.
export const DiscussionThread = React.memo(({ thread, currentUserInitials, isSubmitting, onReplySubmit }: DiscussionThreadProps) => {
    return (
