...
// ⚡ Bolt: Memoized DiscussionThread to prevent expensive re-rendering across the entire thread list
// when typing a reply into a single thread box. Passes isolated `isSubmitting` boolean rather than global `submittingReplyId`.
