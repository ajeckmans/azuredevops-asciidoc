...
// ⚡ Bolt: Wrapped DiscussionThread in React.memo and used isSubmitting instead of
// submittingReplyId to prevent entire list re-renders when one thread is submitting.
