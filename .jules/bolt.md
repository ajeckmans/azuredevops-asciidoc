...
## 2026-07-26 - Prevent O(N) re-renders in lists
**Learning:** Passing global ID state to list items causes O(N) renders. Deriving targeted booleans and memoizing prevents this.
**Action:** Use React.memo and pass derived booleans like `isSubmitting={id === item.id}` to list children.
